...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label->setGeometry(QRect(123, 20, 141, 31));
        QFont font;
        ...
        iniciar->setGeometry(QRect(60, 100, 81, 41));
        parar = new QPushButton(centralWidget);
        parar->setObjectName(QStringLiteral("parar"));
        parar->setGeometry(QRect(220, 100, 81, 41));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        parar->setText(QApplication::translate("MainWindow", "ZERAR", nullptr));
    } // retranslateUi
